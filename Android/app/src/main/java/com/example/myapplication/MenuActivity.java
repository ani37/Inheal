...
import com.example.myapplication.DoctorUI.DoctorAppointments;
import com.example.myapplication.DoctorUI.DoctorMenuActivity;
...
public class MenuActivity extends AppCompatActivity {
    ...
    public void Recomender(View view) {
        Intent intent = new Intent(MenuActivity.this, Recomender.class);
        startActivity(intent);
    }
    ...
    public void onBackPressed() {
        ...
        dialog.setContentText("Are you sure want to close Inheal ?");
